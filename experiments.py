...
# should take in a list of sketches 
# list of sketch sizes 
# cw is kind of slow! 
...
#TODO: make this PFD sketch with fixed alpha, easier to justify why we are doing this
class BatchSketchExperiment(Experiment):
	"""
	determine which batch size to choose for a given l, matrix 
	"""
	def __init__(self, exp_name, mat_fname, l, batch_sizes, randomized=False):
		self.l = l
